---
title: "Single species 5 year simulation analysis"
...
```
Seed and juveniles have a very slow growth, still.
...
ggplot(filter(spproduction,stage =="a"), aes(x=week, y= veg.mean, color = factor(stage))) +
  ...
  theme(legend.position = "none")
```
Check variation at stage-level
```{r}
# Species-specific biomass production
